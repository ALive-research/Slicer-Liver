...
inline const std::vector<double>& expectedBezierControlPoints()
{
  static const std::vector<double> EXPECTED = {
    ...
    -1.1993149957370571e-18,
    -5.5479463418562525e-36,
    4.6259292692714869e-18,
    3.3333333333333387e-01,
    1.5419764230904974e-18,
    4.6259292692714907e-18,
    6.6666666666666718e-01,
    3.0839528461809933e-18,
    4.6259292692714853e-18,
    1.0000000000000002e+00,
    4.6259292692714853e-18,
    // i=1
    3.3333333333333365e-01,
    -1.1993149957370510e-18,
    -3.9977166524568520e-19,
    3.3333333333333370e-01,
    3.3333333333333370e-01,
    1.1111111111111140e-01,
    3.3333333333333431e-01,
    6.6666666666666785e-01,
    2.2222222222222271e-01,
    3.3333333333333370e-01,
    1.0000000000000000e+00,
    3.3333333333333370e-01,
    // i=2
    6.6666666666666730e-01,
    -1.1993149957370633e-18,
    -7.9954333049137040e-19,
    6.6666666666666741e-01,
    3.3333333333333437e-01,
    2.2222222222222279e-01,
    6.6666666666666863e-01,
    6.6666666666666841e-01,
    4.4444444444444542e-01,
    6.6666666666666741e-01,
    ...
    3.3333333333333381e-01,
    3.3333333333333381e-01,
    1.0000000000000022e+00,
    6.6666666666666741e-01,
    6.6666666666666741e-01,
...
{
  static const std::vector<double> EXPECTED = {
    3.0696780014396787e+00,  5.1239779468424333e-02,  -2.9789149140810579e-02, 1.9514873662662355e+00,  2.2036188853356678e-01,  4.2702746974910076e-02,  -2.6309229837804714e-02,
    -6.4267881945438213e-02, 6.6786943662647752e-03,  2.2418342923058746e-01,  -4.0019158286106520e-02, 1.0054240564985091e+00,  3.5070359011478724e-01,  2.3751119059978693e-02,
    5.7765748378587360e-03,  -3.1926498794324062e-02, 1.8841777989148448e-02,  -6.3265267683567286e-02, -5.9072088792485336e-02, -2.8677448082430942e-03, -4.4021774738493948e-03,
    -2.4910202986012455e-02, -2.2814268970371837e-03, -3.8266183368038165e-02, 1.4297493082861342e-02,  3.8157120315777809e-03,  -5.1047708828664178e-03, 3.5915138362602329e-02,
    -4.0701176860480524e-03, -1.1736870556792744e-02, -3.7731670425895304e-03, -2.1498528837345801e-03, 3.2019220293054503e-03,  4.9367515048579389e-03,  -3.1462453950325381e-03,
    3.6203948075069090e-02,  2.7504669785076315e-02,  2.9615241918178881e-03,  3.7673554870742667e-04,  2.9205527446133943e-03,  5.4285520231319266e-03,  -3.6534590699282741e-03,
    -8.0002053361613468e-03, -3.0729534019550858e-03, -4.8578519669361986e-04, -3.2105247026203479e-03, -1.4167817826331423e-03, 2.8554590182290700e-03,
  };
  return EXPECTED;
}
...
inline bool allClose(const double* a, const double* b, size_t n, double rtol, double atol, size_t* failIdx = nullptr)
{
...
inline void printFailure(const char* name, const double* actual, const double* expected, size_t n, size_t failIdx, double rtol, double atol)
{
  std::fprintf(stderr,
               ...
               actual[failIdx],
               expected[failIdx],
               std::fabs(actual[failIdx] - expected[failIdx]),
               rtol,
               atol);
}
